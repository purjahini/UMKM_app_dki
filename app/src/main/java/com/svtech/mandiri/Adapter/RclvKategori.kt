...
import com.svtech.mandiri.Activities.AddKategoriActivity
import com.svtech.mandiri.Models.Kategori
...
class RclvKategori(val context: Context,var listKategori : MutableList<Kategori>): RecyclerView.Adapter<RclvKategori.ViewHolder>() {
