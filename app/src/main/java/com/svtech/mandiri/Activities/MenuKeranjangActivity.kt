...
import com.svtech.mandiri.Adapter.RclvItemTransaksi
        ...
        btnCheckout.setOnClickListener {
            ...
            if (transaksi != null) {
                if (transaksi.totalPembayaran!! >= transaksi.bayar!!) {
                    ...
                    val btnVa = btnSheet.btnVa
                    val btnQr = btnSheet.btnqr

                    btnVa.setOnClickListener {
                        val intent = Intent(this, VaDanQrDKI::class.java)
                        intent.putExtra("Total", transaksi?.totalPembayaran)
                        startActivity(intent)
                    }

                    btnQr.setOnClickListener {
                        val intent = Intent(this, QrisMockUp::class.java)
                        intent.putExtra("Total", transaksi?.totalPembayaran)
                        startActivity(intent)
