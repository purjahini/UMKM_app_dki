...
import com.svtech.mandiri.Utils.ExtensionFunctions.dp2px
import com.svtech.mandiri.Utils.FileUtils.grantedUri
import com.svtech.mandiri.Utils.FileUtils.pathFromUri
import com.svtech.mandiri.Utils.ImageUtil.modifyOrientationSuspending
import com.svtech.mandiri.Utils.PermissionUtils.hasPermissions
import com.svtech.mandiri.callback.ChoosePhotoCallback
        ...
        return if (!filePath.isNullOrBlank() || alwaysShowRemoveOption == true) {
            mutableListOf<Map<String, Any>>(
                mutableMapOf(
                    ...
                    KEY_ICON to R.drawable.ic_photo_camera_black_48dp
                ),
                mutableMapOf(
                    KEY_TITLE to activity.getString(R.string.gallery),
                    KEY_ICON to R.drawable.baseline_image_24
                ),
                mutableMapOf(
                    KEY_TITLE to activity.getString(R.string.remove_photo),
                    KEY_ICON to R.drawable.ic_delete_24
                )
            )
        } else {
            mutableListOf<Map<String, Any>>(
