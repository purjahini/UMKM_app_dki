...
class RclvLaporanTodaysDetail(val context: Context, var listItemMenu: List<ResponseTransaksiTodays.Data>) :
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun getDataInvoice(tanggal: String) {
            ...
            token =
                com.svtech.mandiri.Utils.getPreferences(itemView.context).getString(MyConstant.TOKEN, "").toString()
            username =
                com.svtech.mandiri.Utils.getPreferences(itemView.context).getString(MyConstant.CURRENT_USER, "")
                    .toString()
